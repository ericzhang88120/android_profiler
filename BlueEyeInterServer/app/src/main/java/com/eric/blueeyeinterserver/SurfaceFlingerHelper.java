...
public class SurfaceFlingerHelper {
    ...
    private static String WINDOWS_LIST = "dumpsys SurfaceFlinger --list";
    ...
    public static boolean dumpFrameLatency(String windowName, boolean ignorePendingFenceTime) {
        ...
        if (windowName != null) {
            ...
            //command = "dumpsys SurfaceFlinger --latency com.sina.weibo/com.sina.weibo.MainTabActivity#0";
        ...
        try {
            ...
            System.out.println("reading refresh period: " + mRefreshPeriod);
            if (mRefreshPeriod < 0) {
                return false;
            }
    ...
    public static double getFrameRate() {
        ...
        return Math.round(((mFrameLatencySampleSize - 1) * Math.pow(10, 9))/totalDuration);
    }
    ...
    public static String GetRealWindowName(String packagename){
        Process p = null;
        BufferedReader resultReader = null;
        String command = WINDOWS_LIST;
        String res = null;
        log("Get Current window lists command:"+command);
        try{
